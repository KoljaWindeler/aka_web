...
list($grossezahl) = mysql_fetch_row(mysql_query("SELECT time FROM `".$db_counter."` WHERE typ='9'"));
$ges=$Allelines+$grossezahl;

//backup
if(empty($grossezahl)) { mysql_query("INSERT INTO `".$db_counter."` (time,typ) VALUES ('0','9')"); }
