...
echo	'<table width="100%" class="singletable">
			<tr><th width="35">Nr</th><th width="200">Upload Datum</th> 
...
##### TABELLEN berechnen 
	...
	else { $icon='<img src="img/file-icon.png" widht="40" height="40"  style="float:left;">';}
	...
	$filename_show=str_replace('__','',$filename_show).substr(strtolower(basename($db_filename)),strlen(basename($db_filename))-4);
...
##### TABELLEN anzeige	
	...
	if($_SESSION['session_user_typ']==$aka_files_admin_state || $_SESSION['session_user_typ']==$aka_super_admin_state){
		echo'
