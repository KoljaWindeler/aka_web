...
for($b=0;$b<5;$b++) {
	...
	echo '<tr><td'.$bg_color.'>#'.$c.'</td><td'.$bg_color.'>'.$daten[$b][1].'</td><td'.$bg_color.'><input type="text" name="addbill_'.$daten[$b][0].'"></td><td'.$bg_color.'>'.$daten[$b][6].'  ('.date("d.m.y",$daten[$b][7]).')</td><td'.$bg_color.'>'.$daten[$b][8].' &euro;</td></tr>';
	};
##################### daten sammeln ############################
include('collect_data.php');
