...
if(!empty($_POST['pw']))
	...
	elseif($_POST['pw']==$aka_drinks_pw){
		////session_register('session_user_typ');
		$_SESSION['session_user_typ']=$aka_drinks_admin_state; }

		
	if($_POST['pw']==$aka_pw OR $_POST['pw']==$aka_super_admin_pw OR $_POST['pw']==$aka_drinks_pw) {
